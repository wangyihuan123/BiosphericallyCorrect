...
function SetDefaultValues(field){
    ...
    switch(inputType){
        ...
        case "radio" :
            ...
            field.inputs = null;
            if(!field.choices){
                field.choices = field["enablePrice"] ? new Array(new Choice("<?php _e("First Choice22222", "gravityforms"); ?>", "", "0.00"), new Choice("<?php _e("Second Choice", "gravityforms"); ?>", "", "0.00"), new Choice("<?php _e("Third Choice", "gravityforms"); ?>", "", "0.00"))
                                                     : new Array(new Choice("<?php _e("First1111 Choice", "gravityforms"); ?>"), new Choice("<?php _e("Second Choice", "gravityforms"); ?>"), new Choice("<?php _e("Third Choice", "gravityforms"); ?>"));
            }
            break;
