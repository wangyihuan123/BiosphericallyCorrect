...
class Database extends PDO
{
    ...
    public function __construct()
    {
         ...
         */
        //parent::__construct(DB_TYPE . ':host=' . DB_HOST . ';dbname=' . DB_NAME_LOGIN . ';charset=utf8', DB_USER, DB_PASS, $options);
        parent::__construct(DB_TYPE . ':host=' . DB_HOST . ';dbname=' . DB_NAME_TEST . ';charset=utf8', DB_USER, DB_PASS, $options);
    }
}
