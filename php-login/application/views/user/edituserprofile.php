<div id="content" class="with_sidebar cleaefix">
    ...
    <div class="register-default-box">
        ...
        <br><br>
        <!-- register form -->
        <form method="post" action="<?php echo URL; ?>user/editSaveUserProfile/<?php echo $this->user->user_id;?>" name="profileform" class="form-horizontal" role="form">
...
<!-- 
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-7">
                     <button type="submit" class="btn btn-default col-sm-7">Submit</button>
                </div>
            </div>
        </form>
    </div>
