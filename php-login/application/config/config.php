 ...
 */
//define('URL', 'http://localhost/BiosphericallyCorrect/wp-content/themes/BC-child/php-login/');
define('URL', 'http://localhost/BiosphericallyCorrect/php-login/');
define('DIRECTORY', '/Users/zxl2013/Sites/BiosphericallyCorrect');

require('/Users/zxl2013/Sites/BiosphericallyCorrect/wp-load.php'); 
/**
 * Configuration for: Folders
 * Here you define where your folders are. Unless you have renamed them, there's no need to change this.
 */

define('LIBS_PATH', DIRECTORY . '/php-login/application/libs/');
define('CONTROLLER_PATH', DIRECTORY . '/php-login/application/controllers/');
define('MODELS_PATH', DIRECTORY . '/php-login/application/models/');
define('VIEWS_PATH', DIRECTORY . '/php-login/application/views/');
...
/*
define('LIBS_PATH', get_stylesheet_directory() . '/php-login/application/libs/');
define('CONTROLLER_PATH', get_stylesheet_directory() . '/php-login/application/controllers/');
define('MODELS_PATH', get_stylesheet_directory() . '/php-login/application/models/');
define('VIEWS_PATH', get_stylesheet_directory() . '/php-login/application/views/');
// don't forget to make this folder writable via chmod 775 or 777 (?)
// the slash at the end is VERY important!
define('AVATAR_PATH', get_stylesheet_directory() . '/php-login/public/avatars/');
*/
/**
...
// already defined in wordpress: define('COOKIE_DOMAIN', '.localhost');
...
define('DB_USER', 'root');
// already defined in wordpress: define('DB_HOST', '127.0.0.1');
// already defined in wordpress: define('DB_NAME', 'login');
// already defined in wordpress: define('DB_USER', 'root');
define('DB_PASS', 'ZpCnGva0');
