...
class Emp_QuestionnaireModel
{
    ...
    /**
     * Getter for a single emp question
     * @param int $question_id id of the specific emp question
     * @return object a single object (the result)
     */
    public function getEmpQuestion($question_id)
    {
    ...
    /**
     * Getter for a single emp answer
     * @param int $question_id id of the specific emp question
     * @return object a single object (the result)
     */
    public function getEmpAnswer($question_id)
    {
        $sql = "SELECT * FROM wp_test_emp_answer WHERE user_id = :user_id AND question_id = :question_id";
        $query = $this->db->prepare($sql);
        $query->execute(array(':user_id' => $_SESSION['user_id'], ':question_id' => $question_id));
